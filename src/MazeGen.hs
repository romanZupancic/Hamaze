...
fetchMaze :: Int -> (Int, Int) -> IO ()
fetchMaze seed (width, height) = putStr $ unlines (drawSingleWallMaze $ generateMaze (generateMazeGrid width height) 0 0 (randomList (mkStdGen seed) (0, 11)))
